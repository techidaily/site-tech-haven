---
title: Guide to Terminate Frozen Programs on macOS with Ease
date: 2024-08-27 10:14:30
updated: 2024-08-29 11:29:22
tags:
  - desktop
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/04/macbook-displaying-the-force-quit-applications-window.jpg
---

## Guide to Terminate Frozen Programs on macOS with Ease
...
##  Force Quit Apps Using the Force Quit Menu

 You can find the Force Quit tool under the Apple logo in the menu bar. (You can also open this window by pressing Command+Option+Esc, which is like [the Mac version of Ctrl+Alt+Delete](https://facebook-video-footage.techidaily.com/new-in-2024-a-comprehensible-walkthrough-finding-your-youtube-remarks/).)
...
##  Force Quit an App Using the Activity Monitor
 ...
 You can open Activity Monitor via Launchpad, where you'll find it in the "Other" folder, or [by using Spotlight](https://review-topics.techidaily.com/possible-solutions-to-restore-deleted-pictures-from-infinix-hot-40i-by-fonelab-android-recover-pictures/). To force quit an app, first select it from the list, then click the "X" button in the toolbar at the top.
