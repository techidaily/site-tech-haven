---
title: "Protecting Privacy: How Zoom Ensures Consent Before Utilizing Data for Artificial Intelligence Training"
date: 2024-08-27 14:36:42
updated: 2024-08-29 10:29:32
tags:
  - cutting-edge
categories:
  - tech
...
## Protecting Privacy: How Zoom Ensures Consent Before Utilizing Data for Artificial Intelligence Training

###  UPDATE: 2023/08/08 BY CORBIN DAVENPORT

**_Zoom changed the ToS again_** 

 Zoom has now updated its terms of service agreement again, which the company says will "further confirm that we will not use audio, video, or chat customer content to train our artificial intelligence models without your consent." The original article continues below.
...
> You consent to Zoom’s access, use, collection, creation, modification, distribution, processing, sharing, maintenance, and storage of Service Generated Data for any purpose, to the extent and in the manner permitted under applicable Law, including for the purpose of product and service development, marketing, analytics, quality assurance, machine learning or artificial intelligence (including for the purposes of training and tuning of algorithms and models), training, testing, improvement of the Services, Software, or Zoom’s other products, services, and software, or any combination thereof, and as otherwise provided in this Agreement.
 ...
 The new agreement is alarming because many other companies have been training generative AI with user data and content without direct authorization from the user. Google [confirmed in July](https://www.theverge.com/2023/7/5/23784257/google-ai-bard-privacy-policy-train-web-scraping) that it's training Bard and other AI products using scraped web data, and tools like Stable Diffusion and ChatGPT also rely on data that [wasn't authorized for use in AI products](https://www.vulture.com/2023/07/sarah-silverman-openai-chatgpt-lawsuit.html).
 ...
 For the moment, it doesn't seem like Zoom is using AI in an outright harmful way, but it might be worth looking into alternatives anyway — the service has had [other problems](https://www.wired.com/story/zoom-auto-update-mac-flaws/) over the years. [Jitsi](https://meet.jit.si/) is a popular open-source alternative, which can even be hosted on your own server if desired.

 Source: [Zoom Terms of Service](https://explore.zoom.us/en/terms/), [Zoom Blog](https://blog.zoom.us/zooms-term-service-ai/)
