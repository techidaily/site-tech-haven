...
date: 2024-08-26 15:37:29
updated: 2024-08-29 12:22:44
tags:
  - cutting-edge
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/a-man-speaking-to-a-phone-with-perplexity-s-logo-above-the-screen.jpg
---

## How Perplexity Outperforms ChatGPT with Enhanced Dialogue Capabilities
...
![Perplexity Adds New Voice Chat button](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/perplexity-adds-new-voice-chat-button-1.png) 

 This will open the voice chat interface, which looks like this:

![The Perplexity Voice Chat interface with arrows pointing to the microphone and settings buttons.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/the-perplexity-voice-chat-interface-2.png) 
...
![Perplexity Voice Chat Settings Page](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/perplexity-voice-chat-settings-page-1.png) 

 As you can see, you also have the option to choose between four different voice styles. Mike and Mary have a British accent, while Alex and Kate sound more American. All the voices seem to have a personality and can emote while talking. It isn't the standard [robotic text-to-speech voice](https://vimeo-videos.techidaily.com/in-2024-how-to-make-money-on-vimeo-your-ultimate-guide-to-vimeo-monetization/) that tends to get distracting. But at the same time, the voices still sound like AI and not a human—which I believe is [a feature and not a bug](https://www.npr.org/2024/05/20/1252495087/openai-pulls-ai-voice-that-was-compared-to-scarlett-johansson-in-the-movie-her).
 ...
 While [ChatGPT has offered voice interactions](https://remote-screen-capture.techidaily.com/updated-in-depth-analysis-freelens-webcam-recorder-app/) for some time, Perplexity's implementation is more refined and user-friendly. One of the key improvements is Perplexity's more forgiving approach to accepting voice inputs. Unlike ChatGPT, which can prematurely end input after a brief pause, Perplexity allows you more time to collect your thoughts. This enhancement creates a more natural conversational flow, especially when formulating complex queries or ideas.
...
![Perplexity Sources Overview During Voice Chat](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/perplexity-sources-overview-during-voice-chat-1.png) 
 ...
 Overall, the inclusion of voice chat makes Perplexity that much more useful, further solidifying my stance that it's the [only paid AI chatbot you need](https://graphic-issues.techidaily.com/turnrightview-on-computer/). That said, Perplexity can't generate images during voice chats. I don't know why you'd want to, but if you do, ChatGPT is still the better choice in this regard!
