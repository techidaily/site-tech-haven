---
title: "Big Name Apps Missing From Apple Vision Pro: Exclusive Insight Revealed by ZDNet"
date: 2024-09-28T16:47:37.042Z
updated: 2024-10-04T16:48:15.830Z
tags:
  - apple
categories:
  - tech
...
## Top 10 Desired Enhancements for VisionOS Awaiting Reveal by Apple at the Upcoming WWDC - Insights

![cover](https://www.zdnet.com/a/img/resize/529c891a7d79f7fe36342a1af5742fa6bb8e5c9a/2024/06/03/67c78014-31a9-4c8f-84d9-f969ab2e8866/cover.jpg?auto=webp&width=1280)

David Gewirtz/ZDNET

The [Apple Vision Pro](https://www.zdnet.com/article/apple-vision-pro-faq-price-features-hands-on-insights-and-everything-you-need-to-know/) has been available since February. While it's an impressive device, it's also somewhat challenging and annoying to use. Some of that is unavoidable in a first-ever product in a new category, like the weight of the device and the fairly small field of view. But many annoyances can be addressed in the next release of VisionOS. 

**Also: [What to expect from WWDC 2024: Apple Intelligence, Siri, iOS 18, VisionOS, more](https://www.zdnet.com/article/what-to-expect-from-wwdc-2024-apple-intelligence-siri-ios-18-visionos-more/)**

Apple traditionally announces new operating system features at WWDC this week and releases them with its new products in the fall. While I'd be hard-pressed to believe that a new Vision Pro is coming out this soon, it's almost a foregone conclusion that we're going to see a substantial update of the device's operating system. 
...
I previously showed [how to connect a trackpad and keyboard to the Vision Pro](https://www.zdnet.com/article/hate-the-apple-vision-pro-virtual-keyboard-heres-how-to-use-a-real-keyboard-instead/), but noted that there is no mouse support. Trackpads are nice, but many of us prefer to use mice. 
...
But [Apple says](https://support.apple.com/en-us/118516) that "Apple Vision Pro compatibility with third-party Bluetooth devices and accessories isn't guaranteed." This needs to change, and I hope Apple addresses the problem in VisionOS 2.0\. 
...
Apple currently allows just a few fully immersive environments. While the surface of the moon and Mount Hood are nice enough, they get boring after a while. My immersive environment on the [Quest 3](https://buy.geni.us/Proxy.ashx?TSID=368250&GR%5FURL=https%3A%2F%2Fwww.amazon.com%2FMeta-Quest-128GB-Breakthrough-Reality-3%2Fdp%2FB0C8VKH1ZH%3Ftag%3Dzd-buy-button-20%26ascsubtag%3D%5F%5FCOM%5FCLICK%5FID%5F%5F%7Cc38e9c1f-6415-47cc-be35-e1ce57791800%7Cdtp&dtb=1) is an old mining town. The Quest 3 provides many immersive environments, including inside and outside locations. 
...
Right now, Apple limits the [total physical play space for virtual experiences to a 1.5-meter boundary](https://developer.apple.com/design/human-interface-guidelines/immersive-experiences) around the initial position of the wearer's head. As a person moves closer to the bounds of that boundary, the virtual world recedes and environment passthrough is activated. 
...
**Also: [How to use your Meta Quest in a moving car (as a passenger!)](https://www.zdnet.com/article/how-to-use-your-meta-quest-in-a-moving-car-as-a-passenger/)**

There's more flexibility on the Quest 3\. Using a [fairly dangerous optional setting](https://www.youtube.com/watch?v=mHOHZc24zqk), the Quest 3 allows the boundary to be completely removed. A safer approach is [what this YouTuber does](https://www.youtube.com/watch?v=GhxQs%5F508Lc) to allow for his entire apartment to be included in his Quest 3 play space. 

Maybe, with VisionOS 2.0, Apple will allow for some flexibility in play space boundary size. 

##  8\. VR controller support

While I wouldn't say that the Quest experience beats the Apple Vision Pro experience, some things just work better on the [Quest 3](https://www.zdnet.com/article/zdnet-2023-product-of-the-year-meta-quest-3/). Key to this is the fact that the Quest 3 has controllers, and the Vision Pro relies entirely on hand gestures. It's time for the Vision Pro to add controller support. 

I'll give you one example. I really enjoy the game [Puzzling Places on the Quest 3](https://www.meta.com/experiences/3931148300302917/). But [the game on the Vision Pro](https://apps.apple.com/us/app/puzzling-places/id6473639841) is much more limited because hand gestures on Vision Pro don't provide the level of control over the 3D models that the Quest 3 allows. 
...
This situation was also apparent in [the Marvel What…If? immersive experience](https://www.zdnet.com/article/marvels-what-if-brings-immersive-vr-to-apple-vision-pro-for-free/) I just explored. I found that the hand gestures, while fun, had some lag. [Adam Savage's Tested experienced the same issues](https://www.youtube.com/watch?v=coMrs5KgiV8). 

Most likely, Apple will someday introduce its own controllers, if only to meet some special purpose large-scale enterprise need. But given that Meta has added support for Apple's spatial videos to the Quest 3, it seems only fair for Apple to add support for Quest controllers. I haven't found Quest 3 controllers available separately, but [since the Quest 2 is only $199](https://buy.geni.us/Proxy.ashx?TSID=368250&GR%5FURL=https%3A%2F%2Fwww.amazon.com%2FOculus-Quest-Advanced-All-One-Virtual%2Fdp%2FB099VMT8VZ%3Ftag%3Dzd-buy-button-20%26ascsubtag%3D%5F%5FCOM%5FCLICK%5FID%5F%5F%7Cc38e9c1f-6415-47cc-be35-e1ce57791800%7Cdtp&dtb=1), folks could buy it and get the Quest 2 controllers. Hey, at $199, it's the same price as a [spare Vision Pro battery](https://apple.sjv.io/c/159047/435031/7613?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.apple.com%2Fshop%2Fproduct%2FMW283LL%2FA%2Fapple-vision-pro-battery&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) or [Vision Pro carrying case](https://apple.sjv.io/c/159047/435031/7613?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.apple.com%2Fshop%2Fproduct%2FMW2F3LL%2FA%2Fapple-vision-pro-travel-case&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp).
...
While many reviewers have described the Vision Pro's hand and eye tracking as "magical," I've found eye tracking so difficult I had to [replace it with wrist tracking using accessibility mode](https://www.zdnet.com/article/i-found-apple-vision-pro-unusable-at-first-but-then-i-fixed-it-heres-how/). As I mentioned above, some hand-tracking latency seems to disrupt game play, and I've found that the Vision Pro has difficulty recognizing hand tracking at the very edge or bottom of the visible screen. 
...
<div><ul>
<li><a href="https://fox-access.techidaily.com/new-2024-approved-pinnacle-creations-summary-studio-25-detailed-assessment-2023/"><u>[New] 2024 Approved Pinnacle Creations Summary Studio 25 Detailed Assessment, 2023</u></a></li>
...
<li><a href="https://youtube-clips.techidaily.com/in-2024-dissecting-revenue-allocation-for-shortform-content-makers/"><u>In 2024, Dissecting Revenue Allocation for Shortform Content Makers</u></a></li>
...
<li><a href="https://android-unlock.techidaily.com/the-top-5-android-apps-that-use-fingerprint-sensor-to-lock-your-apps-on-motorola-moto-g-stylus-5g-2023-by-drfone-android/"><u>The Top 5 Android Apps That Use Fingerprint Sensor to Lock Your Apps On Motorola Moto G Stylus 5G (2023)</u></a></li>
