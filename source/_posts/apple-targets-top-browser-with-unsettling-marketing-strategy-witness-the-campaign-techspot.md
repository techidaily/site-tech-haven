...
## Apple Launches a Bold Challenge Against Leading Web Browsers with Startling Commercial Campaign – Witness Here

![creepy-apple-ad](https://www.zdnet.com/a/img/resize/8210be63cb1f86f165a71f7609f91ada68c17ad6/2024/07/18/dc21e20a-5df0-4db8-82ad-93b9ab71e3ce/creepy-apple-ad.jpg?auto=webp&width=1280)

Apple

The world's [most popular cell phone](https://www.zdnet.com/article/need-a-new-phone-here-were-the-worlds-10-hottest-sellers-in-q1-2024/) company is not-so-subtly criticizing the world's most popular browser, and it's doing so in a rather creepy way.

In an ad that [debuted yesterday](https://www.youtube.com/watch?v=0HjDpPnxcP0) on the official Apple YouTube channel, the company calls out browsers that don't protect user privacy, and while it never says so directly, the implication is that it's talking about Google Chrome. You can watch it below.

The ad, which has definite Hitchcock or _Black Mirror_ vibes, shows a city scene with security cameras that turn into birds and bats. The birds fly around people and watch what they're doing on their phones, representing the way websites track your activity. After a minute of the birds spying on various people, a message pops up: "Your browsing is being watched." 
...
**Also: [I'm a browser expert - here are two new reasons why Arc is my default for MacOS](https://www.zdnet.com/home-and-office/work-life/im-a-browser-expert-here-are-two-new-reasons-why-arc-is-my-default-for-macos/)**

The point of the ad is simple. Instead of trusting Google with your privacy, a company that doesn't seem to take it seriously (and recently warned [not to share anything personal with its AI](https://www.zdnet.com/article/dont-tell-your-ai-anything-personal-google-warns-in-new-gemini-privacy-notice/)), trust Apple, a company that seems to put [your privacy at the forefront](https://www.zdnet.com/article/apple-and-google-battle-for-the-future-of-privacy/) (CEO Tim Cook once called privacy a "[basic human right](https://www.zdnet.com/article/can-apple-compete-on-privacy/)").

Google has been working on some privacy-focused initiatives like [stopping third-party cookies](https://www.zdnet.com/article/google-yet-again-delays-killing-third-party-cookies-in-chrome-heres-what-you-need-to-know/), but [collecting and selling your data](https://www.zdnet.com/article/big-tech-is-actually-doing-all-this-with-your-personal-data-true-or-false/) for personalized ads is a large part of its business model. Safari offers a privacy tracking report that [shows what sites are tracking you](https://www.zdnet.com/article/how-to-check-the-privacy-report-for-website-tracking-in-safari/).

**Also: [5 ways to improve your Chrome browser's security (and why you should)](https://www.zdnet.com/article/5-ways-to-improve-your-chrome-browsers-security-and-why-you-should/)**

The question is, will people care enough to make a change? Chrome is the [world's most popular browser](https://www.zdnet.com/home-and-office/networking/chrome-is-obviously-the-top-browser-but-you-wont-believe-whats-2/) by a large margin, and people generally stick with the technology they're comfortable with. Of course, Safari is only available in the Apple ecosystem, so Android and PC users are out of luck anyway. But if you're an Apple user not using Safari, the ad gives you something to think about. 
