...
date: 2024-08-29T02:15:04.573Z
updated: 2024-08-30T02:15:04.573Z
tags:
  - cutting-edge
categories:
  - tech
...
##  Generative AI Search Engines Are Giving Worrying Results
 ...
 Everyone seems to be adding AI to their search products. Some, such as [Perplexity AI](https://screen-sharing-recording.techidaily.com/new-step-by-step-guide-to-recording-on-your-macbook/), have built their entire system around generative AI and Large Language Models (LLMs). Established search outfits, notably Bing and Google, have added these technologies to their existing search engines.

 For example, Google now offers [AI summaries](https://ios-unlock.techidaily.com/in-2024-how-can-i-unlock-my-apple-iphone-13-mini-after-forgetting-my-pin-code-by-drfone-ios/) where the LLM will read web pages so you don't have to, and give you a direct answer to your question. Setting aside how this cuts the actual websites that produce the content out of the loop, when it works it's amazingly useful. However, just like AI chatbots are prone to suffering "[hallucinations](https://audio-shaping.techidaily.com/strategies-for-minimizing-large-scale-video-and-audio-data/)" or making logic and reasoning errors, AI search can fall prey to the same issues.

 This has led to the Google search AI suggesting things like [adding glue to pizza and eating rocks](https://www.cnet.com/tech/services-and-software/glue-in-pizza-eat-rocks-googles-ai-search-is-mocked-for-bizarre-answers/), and that there are [cats on the moon](https://apnews.com/article/google-ai-overviews-96e763ea2a6203978f581ca9c10f1b07). Google, for its part, is rapidly moving to [prune these errors](https://www.theverge.com/2024/5/24/24164119/google-ai-overview-mistakes-search-race-openai), but that doesn't address the fundamental problem—trust.
...
##  Someone Has to Be Responsible for Information in Search Results
 ...
 Even of something like Google's Gemini was 99% accurate and trustworthy, we still have an issue. Of course, humans are rarely that reliable ourselves, but we also rarely have the speed and scale for our errors to cause potentially massive damage. Consider that Google handles around [8.5 billion searches per day](https://www.semrush.com/blog/google-search-statistics/). If only 1% of those searches contained potentially harmful information or advice, that still leaves you with 85 million people being fed something problematic. Every day!
