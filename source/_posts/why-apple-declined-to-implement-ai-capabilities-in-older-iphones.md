---
title: Why Apple Declined to Implement AI Capabilities in Older iPhones
date: 2024-08-26 18:45:31
updated: 2024-08-29 10:47:31
tags:
  - mobile
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/07/your-old-iphone-could-run-apple-intelligence.jpg
---

## Why Apple Declined to Implement AI Capabilities in Older iPhones
...
* Mac Pro (M2 Ultra)
 ...
 The key component missing from older iPhones that limits their ability to run Apple Intelligence is a performnt Neural Processing Unit (NPU) and enough [RAM](https://youtube-web.techidaily.com/ed-2024-approved-unlocking-youtube-success-top-video-strategies-to-explode-views/). You're likely familiar with CPUs and [GPUs](https://android-unlock.techidaily.com/unlock-vivo-s17-pro-phone-password-without-factory-reset-full-guide-here-by-drfone-android/), but NPUs are the new buzzword.
...
##  Apple and Privacy, A Never-Ending Story
 ...
 Since this processing happens on your device, Apple Intelligence can make better use of personal information to better understand context. Unlike other AI systems, your data won't be collected or sent to a remote server. For example, ChatGPT utilizes [Microsoft Azure's](https://video-screen-grab.techidaily.com/new-visual-storytelling-of-pc-playtime-top-6-screenshot-secrets/) cloud infrastructure. This means that when you use ChatGPT, all your information is first uploaded to Microsoft Azure. Then, your request is processed, and you receive the result.
...
##  Changes I Want to See in Apple Intelligence in the Future
 ...
 Secondly, I'm interested in seeing when or even if Apple Intelligence will come to the Apple Watch. The company didn't mention the Apple Watch a single time during [WWDC24](https://extra-hints.techidaily.com/new-comparative-analysis-of-ar-stickers-focusing-on-google/) when taking about Apple Intelligence. This was surprising to me since the Apple Watch could stand to benefit from on-device processing and a smarter Siri. At the very least, I'd love to see the Watch interact with a compatible iPhone.

 Finally, it will be interesting to see if Apple Intelligence will come to the iPhone 16 or if the company will continue offering it only in the Pro version. There are rumors that the [iPhone 16 will feature the A18 chip](https://www.cnet.com/tech/mobile/iphone-16-action-button-ai-bigger-screen-what-to-expect/), an upgrade from the A17 Pro. However, the amount of RAM it will have will determine whether it can run Apple Intelligence.
